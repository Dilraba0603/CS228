...
class DELIVERABLE:
    ...
    def Handle_Vector_From_Leap(self, v):
        ...
        self.x = self.Scale(self.x, self.xMin, self.xMax, 0, self.pygameWindow.pygameWindowWidth)
        self.y = self.Scale(self.y, self.yMin, self.yMax, 0, self.pygameWindow.pygameWindowDepth)
